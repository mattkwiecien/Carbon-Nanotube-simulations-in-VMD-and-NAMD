function [vWater] = tempFind(fin,temp,L,nRings,S,mode,M)
% Parameters of Simulation
fname = strcat('/Users/mkwieci2/Simulations/cnt',num2str(nRings),...
    '_30x30/PBC/',fin,'_run/',num2str(temp),'/',num2str(L*1000),...
    '/',fin,'.veldcd');
% fname = strcat('/Users/mkwieci2/Simulations/cnt',num2str(nRings),...
%     '_4x4/PBC/',num2str(temp),'/',num2str(L*1000),...
%     '/',fin,'.veldcd');
...
switch mode
    ...
    case 1
        ...
        title('600 ring (4,4) CNT, S=-1, T=5K, L=50 ps, F=0.80pN')
