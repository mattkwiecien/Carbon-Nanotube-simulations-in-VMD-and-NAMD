...
% 
% plot(5:length, mean(vWater(:,5:end),1), '--*b','linewidth',2)
% hold on
% 
% plot(1:length, mean(vx(:,nCarbon+1:3:nTot),2),'r', 1:length, mean(vy(:,nCarbon+1:3:nTot),2),'r', 1:length, mean(vz(:,nCarbon+1:3:nTot),2),'r')
% hold on
% set(gca, 'fontsize', 14)
% xlabel('Time (ps)')
